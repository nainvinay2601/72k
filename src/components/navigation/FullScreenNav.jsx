      ...
      <div ref={fullNavLinksRef} className="relative">
        ...
        <div className=" py-10">
          <div className="link origin-top relative border-t-1 border-white">
            <h1 className="font-[primaryBold] text-5xl lg:text-[8vw] text-center lg:leading-[0.8] lg:pt-10 pt-3 uppercase">
              Projets
            </h1>
            <div className="moveLink absolute text-black flex top-0 bg-[#D3FD50]">
              <div className="moveX flex items-center">
                <h2 className="whitespace-nowrap font-[primaryBold] lg:text-[8vw] text-5xl  text-center lg:leading-[0.8] lg:pt-10 pt-4 uppercase">
                  Pour Tout voir
                </h2>
                <img
